...
export const SEED_LISTINGS: Listing[] = [
  ...
  },
  {
    ...
    zone: "Punto Digital · Ciudad del Milagro",
  ...
  },
  {
    ...
    description: "Para el club de programación del Punto Digital de Villa Mitre. Cualquier cantidad suma.",
    tags: ["Protoboard", "Dupont", "Club"],
    zone: "Villa Mitre",
    contact: { type: "email", value: "puntodigital.vm@gmail.com" },
